...
{
    public partial class Latihan5Context : DbContext
    {
        public Latihan5Context()
        {
        }
...
////                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Latihan5;uid=testerr;pwd=pass123;");
////            }
        }
